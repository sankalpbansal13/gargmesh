...
const MATERIALS = [
  mat('ms-annealed', 'MS annealed', 'Soft annealed mild steel', 'Soft black annealed binding wire for tying rebar and mesh.', {
    ...
    detail: 'MS binding wire is soft annealed. It is not sold as a polished or unpolished choice. 25 kg coils.'
  }),
  mat('gi', 'GI (Galvanised)', 'GI', 'Zinc-coated binding wire for outdoor tying.', {
    sort_order: 2,
    best_for: 'Outdoor and fencing ties.',
    detail: 'GI binding wire, 25 kg coils. Not barbed wire.'
  })
];
...
function buildCategory() {
  const designs = GAUGES.map(([slug, label], i) => sku({
    ...
    short_desc: label + ' · MS annealed or GI · 25 kg coils',
    description: 'Binding wire ' + label + '. MS soft annealed or GI. Packed in 25 kg coils. For rebar tying, tying mesh and chain link, and general bundling. Not barbed wire. From Sector 9, Noida.',
  ...
  return hub({
    slug: 'binding-wire',
    name: 'Binding Wire',
    short_desc: '18 g (1.2 mm), 20 g (0.80 mm) and 22 g (0.60 mm). MS annealed and GI. 25 kg coils.',
    description: 'Binding wire from Garg Industrial Mesh, Sector 9 Noida. 18 g (1.2 mm), 20 g (0.80 mm) and 22 g (0.60 mm). MS is soft annealed. GI is zinc-coated. 25 kg coils. Used to tie rebar, mesh and chain link. This is not barbed wire, and polished / unpolished is not a website choice.',
    ...
    guide: [
      {
        ...
        body: 'Millimetres are the Garg gauge chart. MS is soft annealed (easy to twist). GI is zinc-coated for outdoor ties. Coils are 25 kg. Polished and unpolished are not options.',
        tables: [
          [
            ['Gauge', 'Size', 'Pack'],
